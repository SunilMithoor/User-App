...
import com.app.BuildConfig.VERSION_CODE
import com.app.BuildConfig.VERSION_NAME
...
class SupportInterceptor @Inject constructor(private val appSharedPreferences: AppSharedPreferences) :
    Interceptor,
    Authenticator {
